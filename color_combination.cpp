//this program illustrates the concepts of color combination and usage of OpenGL library.

//to start program  press "s"
//to emit red light press "r"
//to emit green light press "g"
//to emit blue light press "b"
...
#include<glut.h>
static double x = 0.0;
static float red1 = 0.0; 
static float green1 = 0.0;
static float blue1 = 0.0;
static float help1 = 1.0;
